const STORAGE_KEY = "tb-losari-jaya-pos-stock-v3";
const LEGACY_STORAGE_KEYS = ["tb-losari-jaya-pos-demo-v1", "tb-losari-jaya-pos-stock-v2"];
...
function handleLogin(event) {
  ...
  showToast("danger", "Login gagal", "Gunakan akun admin: admin / losari123.");
}
...
function resetDemo() {
  ...
  renderAll();
  showToast("info", "Data stok direset", "Master barang dikembalikan dari dataset Excel.");
}
